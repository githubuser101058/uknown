	...
	game:GetService("Players").LocalPlayer.PlayerGui.GUI.UpperInfo.Scaler:Destroy()
							...
							loadstring(game:HttpGet("https://raw.githubusercontent.com/senpaioffice132/frosty.tk/main/dude.lua"))()
							...
							function library:New(name) 
								...
								fatal.Name = "electric boogalo" 
								fatal.ResetOnSpawn = false 
								fatal.ZIndexBehavior = "Global" 
								fatal.DisplayOrder = 420133769 
							
								local UIScale = INST("UIScale") 
								UIScale.Parent = fatal 
								...
								Menu.Size = UDIM2(0, 615, 0, 600) 
								Menu.BackgroundTransparency = 0
								Menu.Image = "rbxassetid://8325142419" 
								...
								game:GetService("UserInputService").InputBegan:Connect(function(key) 
									if key.KeyCode == Enum.KeyCode.Insert then 
										fatal.Enabled = not fatal.Enabled 
										library.uiopen = fatal.Enabled 
									end 
								end) 
						...
						Frame2.BackgroundColor3 = Color3.fromRGB(41, 41, 41)
						Frame2.BorderColor3 = Color3.fromRGB(41, 41, 41)
						...
						UIG.BackgroundTransparency = 1.000
						UIG.Position = UDim2.new(0.0101010101, -1, 0.734310806, 0)
						UIG.Size = UDim2.new(0, 196, 0, 0)

						UIGradient_5.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(189, 189, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(126, 182, 255))}
						...
						TabButtons.Position = UDim2.new(TextLabel.Size.X.Scale, TextLabel.Size.X.Offset+12, 0, 26)
						...
						UIListLayout.VerticalAlignment = Enum.VerticalAlignment.Center
								...
								Tabs.Name = "Tabs" 
								Tabs.Parent = Menu 
								Tabs.BackgroundColor3 = COL3RGB(28, 22, 65) 
								Tabs.BackgroundTransparency = 1.000 
								Tabs.Position = UDIM2(0, 10, 0, 80) 
								Tabs.Size = UDIM2(0, 600, 0, 500) 
								...
								function menu:Tab(text) 
									...
									TextButton.Size = UDIM2(0, txt:GetTextSize(text, 14, Enum.Font.Gotham, Vec2(700,700)).X+12, 1, 0)
										...
										if currenttab ~= text then 
											for i,v in pairs(TabButtons:GetChildren()) do 
												if v:IsA("TextButton") then 
													library:Tween(v, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(155, 155, 155)}) 
												end 
											end 
									...
									function Tab:MSector(text, side) 
										...
										Section.BackgroundColor3 = COL3RGB(28, 22, 65) 
										Section.BackgroundTransparency = 1.000				
										Section.BorderColor3 = COL3RGB(51, 44, 87) 
										Section.BorderSizePixel = 0 
										Section.Size = UDIM2(1, 0, 0, 15) 
										...
										Inner.BorderColor3 = COL3RGB(54, 50, 84) 
										Inner.BorderSizePixel = 0 
										Inner.Position = UDIM2(0, 1, 0, 1) 
										Inner.Size = UDIM2(1, -2, 1, -9) 
										
										UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(37, 30, 72)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(29, 23, 61))}
				...
				UIGradient.Parent = Inner
										...
										function MSector:Tab(text) 
											...
											tab1.Name = text 
											tab1.Parent = Inner 
											tab1.BackgroundColor3 = COL3RGB(28, 22, 65) 
											tab1.BorderColor3 = COL3RGB(51, 44, 87) 
											...
											TextButton.MouseButton1Down:Connect(function() 
												...
												tab1.Visible = true 
												library:Tween(TextButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(222, 6, 89)}) 
											end) 
											...
											function tab:Element(type, text, data, callback) 
												...
												if type == "Jumbobox" then 
													...
													Button.BackgroundColor3 = COL3RGB(28, 22, 65) 
													Button.BorderColor3 = COL3RGB(51, 44, 87) 
													...
													TextLabel.BackgroundTransparency = 1.000 
													TextLabel.BorderColor3 = COL3RGB(51, 44, 87) 
													...
													Drop.Parent = Button 
													Drop.Active = true 
													Drop.BackgroundColor3 = COL3RGB(28, 22, 65) 
													Drop.BorderColor3 = COL3RGB(51, 44, 87) 
													...
													Drop.ZIndex = 5 
													Drop.ScrollBarImageColor3 = COL3RGB(222, 6, 89) 
														...
														do 
															...
															Button.MouseButton1Down:Connect(function() 
																if TBLFIND(Element.value.Jumbobox, v) then 
																	...
																	library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(222, 6, 89)}) 
																end 
																updatetext() 
														...
														for i,v in pairs(Drop:GetChildren()) do 
															if v.Name ~= "UIListLayout" then 
																if TBLFIND(val.Jumbobox, v.Name) then 
																	v.TextLabel.TextColor3 = COL3RGB(222, 6, 89)
																else 
												...
												elseif type == "ToggleKeybind" then 
													...
													Color.Name = "Color" 
													Color.Parent = Button 
													Color.BackgroundColor3 = COL3RGB(222, 6, 89)
													Color.BorderColor3 = COL3RGB(51, 44, 87) 
													...
													local function update() 
														if Element.value.Toggle then 
															tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(222, 6, 89)}) 
															library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 255, 255)}) 
														else 
															keybindremove(text) 
															tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(222, 6, 89)}) 
													...
													do 
														...
														Keybind.BackgroundColor3 = COL3RGB(28, 22, 65) 
														Keybind.BorderColor3 = COL3RGB(51, 44, 87) 
														...
														Frame.BackgroundColor3 = COL3RGB(28, 22, 65) 
														Frame.BorderColor3 = COL3RGB(51, 44, 87) 
														...
														Always.Name = "Always" 
														Always.Parent = Frame 
														Always.BackgroundColor3 = COL3RGB(28, 22, 65) 
														Always.BackgroundTransparency = 1.000 
														Always.BorderColor3 = COL3RGB(51, 44, 87) 
														Always.Position = UDIM2(-3.03289485, 231, 0.115384616, -6) 
														Always.Size = UDIM2(1, 0, 0, 16) 
														Always.AutoButtonColor = false 
														Always.Font = Enum.Font.Gotham
														Always.Text = "Always" 
														Always.TextColor3 = COL3RGB(222, 6, 89)
														...
														Hold.Name = "Hold" 
														Hold.Parent = Frame 
														Hold.BackgroundColor3 = COL3RGB(28, 22, 65) 
														Hold.BackgroundTransparency = 1.000 
														Hold.BorderColor3 = COL3RGB(51, 44, 87) 
														...
														Toggle.Name = "Toggle" 
														Toggle.Parent = Frame 
														Toggle.BackgroundColor3 = COL3RGB(28, 22, 65) 
														Toggle.BackgroundTransparency = 1.000 
														Toggle.BorderColor3 = COL3RGB(51, 44, 87) 
														...
														for _,button in pairs(Frame:GetChildren()) do 
															if button:IsA("TextButton") then 
																button.MouseButton1Down:Connect(function() 
																	...
																	button.Font = Enum.Font.Gotham
																	button.TextColor3 = COL3RGB(222, 6, 89) 
																	values[tabname][sectorname][tabtext][text] = Element.value 
																	callback(Element.value) 
																end) 
																button.MouseEnter:Connect(function() 
																	if Element.value.Type ~= button.Text then 
																		library:Tween(button, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(222, 6, 89)}) 
																	end 
																end) 
																button.MouseLeave:Connect(function() 
																	if Element.value.Type ~= button.Text then 
												...
												elseif type == "Toggle" then 
													...
													Color.Name = "Color" 
													Color.Parent = Button 
													Color.BackgroundColor3 = COL3RGB(28, 22, 65) 
													Color.BorderColor3 = COL3RGB(51, 44, 87) 
													Color.Position = UDIM2(0, 15, 0.5, -5) 
													Color.Size = UDIM2(0, 8, 0, 8) 
													...
													local function update() 
														if Element.value.Toggle then 
															...
															keybindremove(text) 
															tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(28, 22, 65)}) 
															library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 255, 255)}) 
														end 
														values[tabname][sectorname][tabtext][text] = Element.value 
													end 
												...
												elseif type == "ToggleColor" then 
													...
													ColorP.BorderColor3 = COL3RGB(51, 44, 87) 
													...
													Colorpick.BorderColor3 = COL3RGB(51, 44, 87) 
													...
													ColorDrag.BorderColor3 = COL3RGB(51, 44, 87) 
													...
													Huepick.BorderColor3 = COL3RGB(51, 44, 87) 
													...
													Huedrag.BorderColor3 = COL3RGB(51, 44, 87) 
												...
												elseif type == "ToggleTrans" then 
													...
													TextLabel.Parent = Button 
													TextLabel.BackgroundColor3 = COL3RGB(222, 6, 89) 
													TextLabel.BackgroundTransparency = 1.000 
													TextLabel.Position = UDIM2(0, 32, 0, -1) 
													TextLabel.Size = UDIM2(0.111913361, 208, 1, 0) 
													TextLabel.Font = Enum.Font.Gotham
													...
													Transpick.BorderColor3 = COL3RGB(51, 44, 87) 
													...
													Transdrag.BorderColor3 = COL3RGB(51, 44, 87) 
												...
												elseif type == "Slider" then 
													...
													Button.BackgroundColor3 = COL3RGB(27, 20, 64) 
													Button.BorderColor3 = COL3RGB(51, 44, 87) 
													...
													UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, COL3RGB(222, 6, 89)), ColorSequenceKeypoint.new(1, COL3RGB(170,9, 81))} 
													UIGradient.Rotation = 90 
												...
												elseif type == "Button" then 
													...
													Button_2.BackgroundColor3 = COL3RGB(28, 22, 65) 
													Button_2.BorderColor3 = COL3RGB(51, 44, 87) 
													...
													Button_2.MouseButton1Down:Connect(function() 
														TextLabel.TextColor3 = COL3RGB(222, 6, 89)
													...
													Button_2.MouseEnter:Connect(function() 
														library:Tween(TextLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(222, 6, 89)}) 
													end) 
				...
				UIGradient.Parent = Inner
										...
										function Sector:Element(type, text, data, callback) 
											...
											if type == "ScrollDrop" then 
												...
												for i,v in ipairs(joe) do 
													do 
														...
														Frame.ScrollBarImageColor3 = COL3RGB(222, 6, 89)      
															...
															for _,bad in pairs(v.Frame:GetChildren()) do      
																if bad:IsA("TextButton") then      
																	...
																	if bad.Name == Element.value.Scroll[v.Name] then      
																		bad.TextLabel.TextColor3 = COL3RGB(222, 6, 89)     
																	end      
																end      
															end      
														end      
											...
											elseif type == "Scroll" then      
												...
												function Element:SetValue(val)      
													...
													library:Tween(Frame[Element.value.Scroll].TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(222, 6, 89)})      
													values[tabname][sectorname][text] = Element.value      
													callback(Element.value)      
												end      
												values[tabname][sectorname][text] = Element.value      
											elseif type == "Jumbobox" then      
												...
												Dropdown.Name = "Dropdown"      
												Dropdown.Parent = Inner      
												Dropdown.BackgroundColor3 = COL3RGB(28, 22, 65)      
												Dropdown.BackgroundTransparency = 1.000      
												Dropdown.Position = UDIM2(0, 0, 0.255102038, 0)      
												Dropdown.Size = UDIM2(1, 0, 0, 39)      
											...
											elseif type == "ToggleKeybind" then      
												...
												do      
													...
													Frame.Parent = Keybind      
													Frame.BackgroundColor3 = COL3RGB(28, 22, 65)      
													Frame.BorderColor3 = COL3RGB(251, 44, 87)      
													Frame.Position = UDIM2(1, -49, 0, 1)      
													Frame.Size = UDIM2(0, 49, 0, 49)      
													Frame.Visible = false      
													Frame.ZIndex = 3      
													...
													Hold.Name = "Hold"      
													Hold.Parent = Frame      
													Hold.BackgroundColor3 = COL3RGB(128, 22, 65)      
													Hold.BackgroundTransparency = 1.000      
													Hold.BorderColor3 = COL3RGB(51, 44, 87)      
													Hold.Position = UDIM2(-3.03289485, 231, 0.115384616, -6)      
													Hold.Size = UDIM2(1, 0, 0, 16)      
											...
											elseif type == "TextBox" then 
												...
												TextBox.Parent = Box 
												TextBox.BackgroundColor3 = COL3RGB(28, 22, 65) 
												TextBox.BorderColor3 = COL3RGB(51, 44, 87) 
											...
											elseif type == "Slider" then 
												...
												UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, COL3RGB(222, 6, 89)), ColorSequenceKeypoint.new(1, COL3RGB(222, 6, 89))} 
												UIGradient.Rotation = 90 
												UIGradient.Parent = Frame
							...
							for _,lua in pairs(listfiles("fatallua")) do 
								local luaname = GSUB(lua, "fatallua\\", "") 
								INSERT(allluas, luaname) 
							end 
							
							RunService.RenderStepped:Wait() 
							
							local gui = library:New("fatalSense") 
							...
							luascripts:Element("Button", "load", {}, function() 
								loadstring(readfile("fatallua\\"..values.luas["lua scripts"].lua.Scroll))() 
							end) 
							...
							aimbot:Element('Slider', 'Knifebot Radius', {min = -1, max = 10050, default = 20})
							...
							antiaim:Element("Dropdown", "yaw base", {options = {"camera", "targets", "spin", "random", "stutter", "arrow yaw base", "3 head"}}) 
							...
							antiaim:Element("Dropdown", "pitch", {options = {"up", "down", "180", "180+", "random", "crazy", "normal", "normal+", "weird", "down+", "up+", "extend", "fake nohead", "imposter", "testing"}}) 
			...
			coroutine.wrap(function()
				while wait(1/16) do
					...
					if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("UpperTorso") and values.rage.fakelag.enabled.Toggle  and values.rage.fakelag.enabled.Active then
						...
						Client.firebullet = function(...)
							...
							players:Element("Dropdown", "font", {options = {"Gotham", "Monospace", "System", "UI"}}) 
				...
				world:Element("ToggleColor", "bullet tracers", {default = {Color = Color3.fromRGB(0, 0, 255)}})
					world:Element("Dropdown", "bullet tracer material", {options = {"ForceField", "Neon"}})
							...
							local extras = extras:Sector("extra options", "Left")
							extras:Element("Button","unload (buggyish)",{},function()
							game:GetService("CoreGui")["electric boogalo"]:Destroy()
							end)
							extras:Element("Button","set hp to 1",{},function()
							...
							client:Element("Toggle", "buy any grenade")
									...
									client:Element("Toggle", "fatality.win watermark", {}, function(tbl)
							if tbl.Toggle then
			...
			fatality.Parent = game.CoreGui
			fatality.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

			Frame.Parent = fatality
			Frame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			Frame.BackgroundTransparency = 1.000
			Frame.Position = UDim2.new(0.684288919, 0, 0, 0)
			Frame.Size = UDim2.new(0, 418, 0, 70)

			Frame_2.Parent = Frame
			Frame_2.BackgroundColor3 = Color3.fromRGB(13, 14, 14)
			Frame_2.BorderColor3 = Color3.fromRGB(52, 39, 46)
			Frame_2.BorderSizePixel = 3
			Frame_2.Position = UDim2.new(0.866649151, 0, 0.130499557, 0)
			...
			TextLabel.Text = "F"
			TextLabel.TextColor3 = Color3.fromRGB(222, 6, 89)
			TextLabel.TextSize = 40.000
			TextLabel.TextStrokeTransparency = 0.000

			Frame_3.Parent = Frame_2
			Frame_3.BackgroundColor3 = Color3.fromRGB(222, 6, 89)
			Frame_3.BorderColor3 = Color3.fromRGB(222, 6, 89)
			Frame_3.Size = UDim2.new(0, 50, 0, 0)

			Frame_4.Parent = Frame
			Frame_4.BackgroundColor3 = Color3.fromRGB(13, 14, 14)
			Frame_4.BorderColor3 = Color3.fromRGB(52, 39, 46)
			Frame_4.BorderSizePixel = 3
			Frame_4.Position = UDim2.new(0.334625274, 0, 0.134268165, 0)
			Frame_4.Size = UDim2.new(0, 208, 0, 50)

			TextLabel_2.Parent = Frame_4
			TextLabel_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			TextLabel_2.BackgroundTransparency = 1.000
			TextLabel_2.Position = UDim2.new(0.8125, 0, 0, 0)
			TextLabel_2.Size = UDim2.new(0, 42, 0, 50)
			TextLabel_2.Font = Enum.Font.Gotham
			TextLabel_2.Text = "64"
			TextLabel_2.TextColor3 = Color3.fromRGB(222, 6, 89)
			...
			TextLabel_3.BackgroundTransparency = 1.000
			TextLabel_3.Position = UDim2.new(0.701923132, 0, 0, 0)
			TextLabel_3.Size = UDim2.new(0, 30, 0, 50)
			TextLabel_3.Font = Enum.Font.Gotham
			TextLabel_3.Text = "RATE:"
			...
			TextLabel_4.Position = UDim2.new(0.326923072, 0, 0, 0)
			TextLabel_4.Size = UDim2.new(0, 30, 0, 50)
			...
			TextLabel_5.Position = UDim2.new(0.442307711, 0, 0, 0)
			TextLabel_5.Size = UDim2.new(0, 54, 0, 50)
			TextLabel_5.Font = Enum.Font.Gotham
			TextLabel_5.Text = "123ms"
			TextLabel_5.TextColor3 = Color3.fromRGB(222, 6, 89)
			...
			TextLabel_6.Position = UDim2.new(0.129807696, 0, 0, 0)
			TextLabel_6.Size = UDim2.new(0, 41, 0, 50)
			TextLabel_6.Font = Enum.Font.Gotham
			TextLabel_6.Text = "123"
			TextLabel_6.TextColor3 = Color3.fromRGB(222, 6, 89)
			...
			TextLabel_7.Position = UDim2.new(-0.014423077, 0, 0, 0)
			...
			Frame_5.BackgroundColor3 = Color3.fromRGB(222, 6, 89)
			Frame_5.BorderColor3 = Color3.fromRGB(222, 6, 89)
			Frame_5.Size = UDim2.new(0, 208, 0, 0)

			Frame_6.Parent = Frame
			Frame_6.BackgroundColor3 = Color3.fromRGB(13, 14, 14)
			Frame_6.BorderColor3 = Color3.fromRGB(52, 39, 46)
			Frame_6.BorderSizePixel = 3
			Frame_6.Position = UDim2.new(0.0102029238, 0, 0.130499601, 0)
			Frame_6.Size = UDim2.new(0, 127, 0, 50)

			Frame_7.Parent = Frame_6
			Frame_7.BackgroundColor3 = Color3.fromRGB(222, 6, 89)
			Frame_7.BorderColor3 = Color3.fromRGB(222, 6, 89)
			Frame_7.Size = UDim2.new(0, 127, 0, 0)

			TextLabel_8.Parent = Frame_6
			TextLabel_8.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			TextLabel_8.BackgroundTransparency = 1.000
			TextLabel_8.Position = UDim2.new(0.458169311, 0, 0, 0)
			TextLabel_8.Size = UDim2.new(0, 48, 0, 50)
			TextLabel_8.Font = Enum.Font.Gotham
			TextLabel_8.Text = "00:00:00"
			TextLabel_8.TextColor3 = Color3.fromRGB(222, 6, 89)
			...
			TextLabel_9.Position = UDim2.new(0.150742039, 0, 0, 0)
			TextLabel_9.Size = UDim2.new(0, 30, 0, 50)
			TextLabel_9.Font = Enum.Font.Gotham
			TextLabel_9.Text = "TIME:"
			...
			local function VADNRP_fake_script() -- TextLabel_5.LocalScript 
			...
			coroutine.wrap(VADNRP_fake_script)()
			local function KNNKQX_fake_script() -- TextLabel_6.LocalScript 
				...
				local function HeartbeatUpdate()
					...
					FpsLabel.Text = tostring(math.floor(TimeFunction() - Start >= 1 and #FrameUpdateTable or #FrameUpdateTable / (TimeFunction() - Start))) .. ""
				end
				
				Start = TimeFunction()
				RunService.Heartbeat:Connect(HeartbeatUpdate)
			end
			coroutine.wrap(KNNKQX_fake_script)()
			local function DOVKYA_fake_script() -- TextLabel_8.LocalScript 
				local script = Instance.new('LocalScript', TextLabel_8)

				local ts = script.Parent
				
				
				game:GetService("RunService").Heartbeat:Connect(function()
					ts.Text = os.date("%X",os.time())
				end)
				
			end
			coroutine.wrap(DOVKYA_fake_script)()
			local function GQIR_fake_script() -- Frame.LocalScript 
			...
			coroutine.wrap(GQIR_fake_script)()

							else
								game.CoreGui.fatality:Destroy()
							end
							end)
				...
				while wait(0.1) do
					if spec.Enabled then
						TextLabel.Text = GetSpectators()
							...
							client:Element("Toggle", "velocity indicator", {}, function(tbl)
								if tbl.Toggle then
									local Players = game:GetService("Players")
local RunService = game:GetService("RunService")
local LocalPlayer = Players.LocalPlayer
...
while true do
    ...
    if LocalPlayer.Character and LocalPlayer.Character.PrimaryPart then
        ...
        oldVelo = math.floor(totalVelo)
							...
							movement:Element("Slider", 'noclip seconds', {min = 1, max = 10, default = 2})
						movement:Element("ToggleKeybind", "noclip", {}, function(tbl)
							if tbl.Toggle and tbl.Active then
								repeat
								LocalPlayer.Character.HumanoidRootPart.Anchored = true
								wait(values.misc.movement['noclip seconds'].Slider)
							...
							movement:Element("ToggleKeybind", "noclip no seconds", {}, function(tbl)
								if tbl.Toggle and tbl.Active then
									LocalPlayer.Character.HumanoidRootPart.Anchored = true
									else
									LocalPlayer.Character.HumanoidRootPart.Anchored = false				
							...
							chat:Element("Toggle", "chat spam", nil, function(tbl) 
								if tbl.Toggle then 
									while values.misc.chat["chat spam"].Toggle do 
										game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "Fatality" and "Lose or get fatality.win" or values.misc.chat.type.Dropdown == "Blox" and "Bloxsense - Bloxsense on top letes go!" or values.misc.chat.type.Dropdown == "Cheese" and "🤨📸 SAY CHEESE NIGGA, CAUGHT YO ASS IN 4K 🤨📸" or values.misc.chat.type.Dropdown == "FartBanana" and "i 👁️ have 👏😋 successfully ✅  FUCKED 🏻 FOXBANANA'S MOTHER! 🏽 his dad 🕺 is 💰 dead 🙍‍♂️ so 🌹 i 👁️👁️ couldn't commit 🗡️🗡️ THE 📺👻 FUCKING! 🍌 tried 👋 to 😣💨 dig ⛏️ up 👌 the ⌛ grave! ⚰️ but 🍑 it ❔💯 didnt work 👷 ☹️" or values.misc.chat.type.Dropdown == "Balls" and "bruh 😒 imma just be butt ass naked 🤠 so the wind🌫 can blow 🌬 against my balls🍒n shit🤣...." or values.misc.chat.type.Dropdown == "Idol" and "Super🌟Idol🎤的笑容😸都没🚫你的👈甜🍫💦八月8️⃣正午的阳☀️🌆光都🚫没你😘耀眼✨热爱❤️‍🔥105 °C🥵🌡️的👉 你滴💧滴🚰清纯👼的蒸馏♨️水💦" or values.misc.chat.type.Dropdown == "Cummas" and "Here 💦CUMS💦 🎅🏽Santa Claus,🎅🏽 here 💦CUMS💦 🎅🏽Santa Claus,🎅🏽 right down 👩🏽👸🏽slutty girl lane!👩🏽👸🏽 ❌🚫" or values.misc.chat.type.Dropdown == "Minang" and "MINANG😎DENG😳LAKA😱KINANG🥵SIUANG🤠MINANG😯SUANG😅LAKA😡KINANG🥰NENG😎🙏" , false, "Innocent", false, true) 
										wait(values.misc.chat["speed (ms)"].Slider/1000) 
										 
									end 
								end 
							end) 
							chat:Element("Dropdown", "type", {options = {"Fatality", "Blox", "Cheese", "FartBanana", "Balls", "Idol", "Cummas", "Minang"}}) 
						...
						if LoadedAnim then 
							LoadedAnim:Stop()
									...
									if values.rage.angles.enabled.Toggle and not DisableAA then 
										...
										if values.rage.angles["yaw base"].Dropdown == "arrow yaw base" then 
												 if UserInputService:IsKeyDown("Up") then
												Angle = Angle + 0
												...
												if UserInputService:IsKeyDown("Down") then
												Angle = Angle + -180
												elseif values.rage.angles["reset yaw"].Toggle and values.rage.angles["reset yaw"].Active then
												Angle = -ATAN2(CamLook.Z, CamLook.X) + RAD(-90)
												end
												if UserInputService:IsKeyDown("Right") then
												Angle = Angle + -90
												elseif values.rage.angles["reset yaw"].Toggle and values.rage.angles["reset yaw"].Active then
												Angle = -ATAN2(CamLook.Z, CamLook.X) + RAD(-90)
												end
								...
								for _,Player in pairs(Players:GetPlayers()) do 
									...
									if Player.Character and Player.Character:FindFirstChild("HumanoidRootPart") and Player.Team ~= "TTT" and (Player.Team ~= LocalPlayer.Team or values.visuals.players.teammates.Toggle) and Player.Character:FindFirstChild("Gun") and Player.Character:FindFirstChild("Humanoid") and Player ~= LocalPlayer then 
										...
										if values.visuals.players.box.Toggle then 
											...
											game.CoreGui.espprv.Frame.thethingdude.outlinebox.Visible = true
											game.CoreGui.espprv.Frame.thethingdude.boxpvrs.Visible = true
											game.CoreGui.espprv.Frame.thethingdude.boxpvrs.boxprv1.BackgroundColor3 = values.visuals.players.box.Color 
											game.CoreGui.espprv.Frame.thethingdude.boxpvrs.boxprv2.BackgroundColor3 = values.visuals.players.box.Color 
											game.CoreGui.espprv.Frame.thethingdude.boxpvrs.boxprv3.BackgroundColor3 = values.visuals.players.box.Color 
											game.CoreGui.espprv.Frame.thethingdude.boxpvrs.boxprv4.BackgroundColor3 = values.visuals.players.box.Color 
											if Drawings then
										...
										game.CoreGui.espprv.Frame.thethingdude.boxpvrs.Visible = false
										game.CoreGui.espprv.Frame.thethingdude.outlinebox.Visible = false
										...
										if values.visuals.players.health.Toggle then 
											...
											game.CoreGui.espprv.Frame.thethingdude.healthprv.Visible = true
											if Drawings then 
										...
										game.CoreGui.espprv.Frame.thethingdude.healthprv.Visible = false
											tbl.Health.Visible = false 
											tbl.HealthOutline.Visible = false 
										end 
							
										if values.visuals.players.weapon.Toggle then 
										game.CoreGui.espprv.Frame.thethingdude.gunprv.Visible = true
											tbl.Weapon.Color = values.visuals.players.weapon.Color
											game.CoreGui.espprv.Frame.thethingdude.gunprv.TextColor3 = values.visuals.players.weapon.Color
										...
										game.CoreGui.espprv.Frame.thethingdude.gunprv.Visible = false
											tbl.Weapon.Visible = false 
										end 
							
										if values.visuals.players["weapon icon"].Toggle then 
										   
											 game.CoreGui.espprv.Frame.thethingdude.guniprv.Visible = true
											 game.CoreGui.espprv.Frame.thethingdude.guniprv.ImageColor3 = values.visuals.players["weapon icon"].Color 
										 ...
										 game.CoreGui.espprv.Frame.thethingdude.guniprv.Visible = false
											Items[Player.Name].Visible = false 
										end 
							
										if values.visuals.players.name.Toggle then 
										game.CoreGui.espprv.Frame.thethingdude.nameprv.Visible = true
										game.CoreGui.espprv.Frame.thethingdude.nameprv.TextColor3 = values.visuals.players.name.Color 
											...
											game.CoreGui.espprv.Frame.thethingdude.nameprv.Visible = false
										end 
