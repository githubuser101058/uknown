				...
				world:Element("ToggleColor", "bullet tracers", {default = {Color = Color3.fromRGB(0, 0, 255)}})
					world:Element("Dropdown", "bullet tracer material", {options = {"ForceField", "Neon"}})
							...
							client:Element("Toggle", "buy any grenade")
									...
									client:Element("Toggle", "ballsack.vip watermark", {}, function(tbl)
							if tbl.Toggle then
local Water = Instance.new("ScreenGui")
local Info = Instance.new("Frame")
local Cheeto = Instance.new("TextLabel")
local Frame = Instance.new("Frame")
local Username = Instance.new("TextLabel")

Water.Name = "Water"
Water.Parent = game.CoreGui
Water.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Info.Name = "Info"
Info.Parent = Water
Info.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
Info.BackgroundTransparency = 0.200
Info.BorderColor3 = Color3.fromRGB(45, 45, 45)
Info.Position = UDim2.new(-1, 0, 0, 29)
Info.Size = UDim2.new(0, 300, 0, 28)

Cheeto.Name = "Cheeto"
Cheeto.Parent = Info
Cheeto.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Cheeto.BackgroundTransparency = 1.000
Cheeto.Position = UDim2.new(0.0362318829, 0, 0, 0)
Cheeto.Size = UDim2.new(0, 266, 0, 28)
Cheeto.Font = Enum.Font.ArialBold
Cheeto.LineHeight = 0.820
Cheeto.Text = "Ballsack.vip - "
Cheeto.TextColor3 = Color3.fromRGB(200, 200, 200)
Cheeto.TextSize = 12.000
Cheeto.TextStrokeTransparency = 0.800
Cheeto.TextXAlignment = Enum.TextXAlignment.Left

Frame.Parent = Info
Frame.BackgroundColor3 = Color3.fromRGB(255, 8, 210)
Frame.BorderColor3 = Color3.fromRGB(255, 8, 210)
Frame.Position = UDim2.new(0, 0, 1.36239194e-07, 0)
...
Username.Position = UDim2.new(0.306666672, 0, 0, 0)
Username.Size = UDim2.new(0, 208, 0, 28)
Username.Font = Enum.Font.ArialBold
Username.LineHeight = 0.820
Username.Text = "rwtmtrjjhoiwtrjhiotrjhitrjhoitrjhoitrjh"
Username.TextColor3 = Color3.fromRGB(200, 200, 200)
Username.TextSize = 12.000
Username.TextStrokeTransparency = 0.800
Username.TextXAlignment = Enum.TextXAlignment.Left

-- Scripts:

local function GIJB_fake_script() -- Username.LocalScript 
...
coroutine.wrap(GIJB_fake_script)()
local function VNOO_fake_script() -- Info.LocalScript 
	local script = Instance.new('LocalScript', Info)

	script.Parent:TweenPosition(UDim2.new(0, 0,0, 29))
	
end
coroutine.wrap(VNOO_fake_script)()
								...
								if (v.CameraCF.Value.p - game.Workspace.CurrentCamera.CFrame.p).Magnitude < 10 then 
									if CurrentSpectators == "" then
										CurrentSpectators = v.Name
											CurrentSpectators = GetPropertyChangedSignal("Team"):Connect(onTeamChanged)
									else
        ...
        oldVelo = math.floor(totalVelo)
						...
						movement:Element("ToggleKeybind", "noclip", {}, function(tbl)
							...
							grenades:Element("Button", "crash server", {}, function() 
									local A_1 = "🖥️🖥️ Server smoked by Fatality % Bloxsense 🖥️🖥️"
                                    local A_2 = false
                                    local A_3 = "Innocent" 
                                    local A_4 = false
                                    local A_5 = true
			...
			animations:Element("Dropdown", "animation", {options = animlist}, function(tbl)
				...
				Dance.AnimationId = animationsplay[tbl.Dropdown]
						...
						FRC.BackgroundColor3 = Color3.fromRGB(255, 8, 210)
						FRC.BorderColor3 = Color3.fromRGB(255, 8, 210)
																		...
																		if #Hits == 0 then
																			...
																			if Damage >= Stats["minimum damage"].Slider then
																				...
																				if values.rage.aimbot["automatic fire"].Dropdown == "standard" then
																					...
																					CreateHitElement("Hit "..EndHit.Parent.Name.." in the "..EndHit.Name,Color3.new(0.8,0.8,0.8))
